...
public final class JsonParser {
	...
	// 투기성 파싱방법임.
	public static Var object(CharTokenizer token) {
	 ...
	 * @return
	 */
	public static String mapKey(CharTokenizer token) {				
	...
	public static Var map(CharTokenizer token) {		
		if (token.read() == '{') {
			token.next();
		}else{
			return null;
	 ...
	 * @return
	 */
	public static Var string(CharTokenizer token) {
	 ...
	 * @return
	 */
	public static Var number(CharTokenizer token) {			
		Long temp = null;		
	 ...
	 * @return
	 */
	public static Var nill(CharTokenizer token) {		
	 ...
	 * @return
	 */
	public static Var bool(CharTokenizer token) {		
	 ...
	 * @return
	 */
	public static boolean startWith(CharTokenizer token, Character ...chars) {
		token.transactionMode();		
