...
public class DjsonTest {
	...
	public void fileTest() throws IOException {
		...
		assertThat(var.find("tistory.item.comments.comment[1].link").toString(),
				is("http://oauth.tistory.com/4#comment8176923"));
	}
	...
	public void longFileTest() throws IOException {
		...
		/**
		 * {"rank":"4", "link":
		 * "http://search.daum.net/search?q=%EC%A0%95%EA%B8%80%EC%9D%98%EB%B2%95%EC%B9%99%20%EB%89%B4%EC%A7%88%EB%9E%9C%EB%93%9C&DA=DLVC&rtmaxcoll=DQP"
		 * , "keyword":"정글의법칙 뉴질랜드" ,"content":
		 * "정석원이 해병대 본능을 발휘했다. 8일 방송된 SBS '정글의 법칙'에서는 새롭게 구성된 병만족 멤버들과의 뉴질랜드 생존기가 첫 전파를 탔다. 병만 족장을 중심으로 기존멤버 리키김, 노우진, 박정철과 새 멤버 이필모, 정석원, 박보영으로"
